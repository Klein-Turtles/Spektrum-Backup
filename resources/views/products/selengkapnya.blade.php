            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                ...
                <div class="col">
                    <div class="product-card h-100">
                        <div class="position-relative">
                            ...
                            <img src="{{ url('/images/categories-product/product/mg90s-servo.png') }}" class="card-img-top product-img"
                                alt="mg90s-servo">
                        </div>
                ...
                <div class="col">
                    <div class="product-card h-100">
                        <div class="position-relative">
                            ...
                            <img src="{{ url('/images/categories-product/product/adapter-ic-TQFP32-1.png') }}" class="card-img-top product-img"
                ...
                <div class="col">
                    <div class="product-card h-100">
                        <div class="position-relative">
                            ...
                            <img src="{{ url('/images/categories-product/product/bme230-humidity.png') }}" class="card-img-top product-img"
                                alt="bme230-humidity">
                        </div>
                        <div class="card-body d-flex flex-column">
                ...
                <div class="col">
                    <div class="product-card h-100">
                        <div class="position-relative">
                            ...
                            <img src="{{ url('/images/categories-product/product/gas-sensor-tgs2600.png') }}" class="card-img-top product-img"
                ...
                <div class="col">
                    <div class="product-card h-100">
                        <div class="position-relative">
                            <span class="badge bg-primary discount-badge">26% Off</span>
                            <img src="{{ url('/images/categories-product/product/l298n-dual-motor-driver-module.png') }}"
